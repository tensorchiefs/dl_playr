############################################################################
# Nearely complete copy of model_3 except beta is not a linear function anymore
...
new_model_4 = function(len_theta = integer(), x_dim, y_range){
  ...
  structure( #strcutur is a bunch of data with 
    ...
    class = "model_4" #class attribute set so it's a class
  )  
}
